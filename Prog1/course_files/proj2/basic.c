...
#define MH 40
#define BRDRSZ 50
#define NUMBER_SQUARES_COLUMN 3 // this  is what you want to change to make the board taller 
#define NUMBER_SQUARES_ROW 3 // change this to make it fatter
...
int main(int argc, char *argv[]){
    ...
    init_graphics(0, 0, WNDWSZ_W, WNDWSZ_H, BORDERC);
    ...
    if((i+j)%2==1)
      ...
      sc = PIECEC;
      drawRect( sc,  i*50, j*50, W, H);
     }
 }
 drawRect( PIECEF, ENDPIECEX, ENDPIECEY, W, H);
 drawRect( PIECEM, x, y, MW, MH); 
